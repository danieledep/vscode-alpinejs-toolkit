...
- Added the `x-resize` `.viewport` modifier introduced in Alpine.js 3.17.4: `.viewport` snippet plus `x-resize` hover/completion coverage of the visual-viewport tracking and document fallback
